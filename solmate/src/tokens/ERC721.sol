...
abstract contract ERC721 {
    ...
    function transferFrom(
        ...
        /**
         @audit ^^ Same problem as in ERC20. `_balanceOf` is internal and mutateable
                   in downstream contract. Invariant (no underflow for owner) only holds
                   if developer does not make mistake!
         */
        unchecked {
            _balanceOf[from]--;
